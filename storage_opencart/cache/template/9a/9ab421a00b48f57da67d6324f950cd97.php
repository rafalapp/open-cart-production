...
class __TwigTemplate_2505ea5846b0d56dc854d28eb1ba4e62 extends Template
{
    ...
    <div class=\"card\">
      ...
      <form id=\"form-filter\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
            // line 11
            yield "              <option value=\"";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["group"], "value", [], "any", false, false, false, 11);
            yield "\"";
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["group"], "value", [], "any", false, false, false, 11) == ($context["filter_group"] ?? null))) {
                yield " selected";
            }
            yield ">";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["group"], "text", [], "any", false, false, false, 11);
            yield "</option>
            ";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["order_status"]) {
            // line 20
            yield "              <option value=\"";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["order_status"], "order_status_id", [], "any", false, false, false, 20);
            yield "\"";
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["order_status"], "order_status_id", [], "any", false, false, false, 20) == ($context["filter_order_status_id"] ?? null))) {
                yield " selected";
            }
            yield ">";
            yield CoreExtension::getAttribute($this->env, $this->source, $context["order_status"], "name", [], "any", false, false, false, 20);
            yield "</option>
            ";
        }
        $_parent = $context['_parent'];
  ...
  <div class=\"col col-lg-9 col-md-12\">
    <div class=\"card\">
      <div class=\"card-header\"><i class=\"fa-solid fa-chart-bar\"></i> ";
        ...
        yield "</div>
      <div id=\"sale-tax\" class=\"card-body\">";
        // line 43
...
\$('#button-filter').on('click', function() {
    ...
    \$('#sale-tax').load('index.php?route=extension/opencart/report/sale_tax.list&user_token=";
        // line 81
...
";
    ...
    {
        return "extension/opencart/admin/view/template/report/sale_tax.twig";
    }
    ...
    {
        return array (  200 => 81,  159 => 43,  155 => 42,  144 => 34,  140 => 33,  132 => 30,  128 => 29,  120 => 26,  116 => 25,  111 => 22,  96 => 20,  92 => 19,  88 => 18,  83 => 16,  78 => 13,  63 => 11,  59 => 10,  54 => 8,  47 => 4,  42 => 1,);
    }
...
//--></script>
", "extension/opencart/admin/view/template/report/sale_tax.twig", "/var/www/upload/extension/opencart/admin/view/template/report/sale_tax.twig");
    }
}
