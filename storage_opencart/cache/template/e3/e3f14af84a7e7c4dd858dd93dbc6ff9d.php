...
class __TwigTemplate_ca2cb456a20227443f142219a23de42b extends Template
{
                ...
                <tr>
                  ...
                  ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                        // line 111
                        yield "                    <td>";
                        if ((($_v0 = CoreExtension::getAttribute($this->env, $this->source, $context["product"], "attribute", [], "any", false, false, false, 111)) && is_array($_v0) || $_v0 instanceof ArrayAccess ? ($_v0[$context["key"]] ?? null) : null)) {
                            yield (($_v1 = CoreExtension::getAttribute($this->env, $this->source, $context["product"], "attribute", [], "any", false, false, false, 111)) && is_array($_v1) || $_v1 instanceof ArrayAccess ? ($_v1[$context["key"]] ?? null) : null);
                        }
                        yield "</td>
                  ";
                    }
...
{{ footer }} 
", "catalog/view/template/product/compare.twig", "/var/www/upload/catalog/view/template/product/compare.twig");
    }
}
